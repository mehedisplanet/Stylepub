...
from .views import register,activate,UserLogin,UserLogout,PurchaseView,WishlistView,CartView,ShowWishlistView,deleteCartProduct,deleteWishProduct,ProfileView,Checkout,PurchaseHistoryView
